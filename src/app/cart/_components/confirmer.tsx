...
const Confirmer = ({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl fixed top-1/2 kinatech-container -translate-y-1/2 left-1/2 -translate-x-1/2 w-[90%] lg:w-1/2 min-h-56 p-padding flex flex-col justify-between gap-5">
        ...
        <div className="flex gap-5 items-center">
          <p className="font-B text-xl text-grey">
            Vous êtes sur le point de retirer{" "}
            <strong className="text-blk">{name}</strong>
            de votre panier. Êtes-vous sûr de vouloir continuer avec cette
            sélection?
          </p>
        </div>
